...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-primary">
      ...
      {/* ═══════════════ PRICING ═══════════════ */}
      <section id="pricing" className="py-24 bg-[#f5f5f5] border-t border-gray-100">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-black text-[#111] mb-8">Compare and select a package</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex items-center justify-between mb-2.5">
                <span className="text-2xl font-black text-[#111]">Starter</span>
                <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-3 py-1 rounded-full bg-[#f0f0f0] text-[#555]">
                  <svg className="w-3 h-3" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 8l3 3 7-7"/></svg>
                  Standard
                </span>
              </div>
              <p className="text-[#555] text-sm leading-relaxed mb-4 min-h-[42px]">Get your LLC or corporation officially formed with all required state filings handled quickly and accurately.</p>
              <div className="text-[2rem] font-black text-[#111] leading-none mb-1">$0</div>
              <p className="text-xs text-[#666] mb-4">+ state fees</p>
              <button
                onClick={() => openPayment({ name: "Starter", price: "$0", color: "bg-primary" })}
                className="block w-full py-3.5 bg-[#111] hover:bg-[#333] text-white font-bold rounded-xl text-center transition-colors mb-5 text-sm"
              >Start now</button>

              {/* Features box */}
              <div className="bg-[#f5f5f5] rounded-xl p-4 mb-5">
                <p className="text-[10px] font-black uppercase tracking-[0.08em] text-[#777] mb-3 pb-2.5 border-b border-black/[0.08]">Included in Starter</p>
                  ...
                  {[
                    ...
                    <div key={text} className="flex items-start justify-between gap-2">
                      <div className="flex items-start gap-2.5 flex-1">
                        <div className="w-7 h-7 rounded-md bg-[#e2e2e2] flex items-center justify-center shrink-0 mt-0.5">
                          <svg className="w-3.5 h-3.5" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" stroke="#555" strokeWidth="1.5" fill="none"/><path d="M5 8l2 2 4-4" stroke="#555" strokeWidth="1.5" fill="none"/></svg>
                        </div>
                        <span className="text-[0.85rem] text-[#222] leading-snug">{text}</span>
                      </div>
                      <Info className="w-4 h-4 text-[#6fa0c8] shrink-0 mt-1" />
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Special offer */}
              <p className="text-[10px] font-black uppercase tracking-[0.08em] text-[#777] mb-3">Special Starter Offer</p>
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-start gap-2.5 flex-1">
                  <div className="w-7 h-7 rounded-md bg-[#e8eef5] flex items-center justify-center shrink-0">
                    <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6" stroke="#4a7eaa" strokeWidth="1.5"/><path d="M8 5v3l2 1" stroke="#4a7eaa" strokeWidth="1.3" strokeLinecap="round"/></svg>
                  </div>
                  <div>
                    <p className="text-[0.85rem] text-[#222] font-semibold leading-snug">Free business banking account</p>
                    <span className="text-[0.78rem] text-[#777]">Setup with our partner bank†</span>
                  </div>
                </div>
                <Info className="w-4 h-4 text-[#6fa0c8] shrink-0 mt-1" />
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-2.5">
                <span className="text-2xl font-black text-[#111]">Pro</span>
                <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-3 py-1 rounded-full bg-[#d4f4e2] text-[#1a7a45]">
                  <svg className="w-3 h-3" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 8l3 3 7-7"/></svg>
                  Most Popular
                </span>
              </div>
              <p className="text-[#555] text-sm leading-relaxed mb-4 min-h-[42px]">Full formation package with EIN, registered agent, operating agreement, and annual compliance filing.</p>
              <div className="text-[2rem] font-black text-[#111] leading-none mb-1">$199</div>
              <p className="text-xs text-[#666] mb-4">+ state fees | renews at <strong className="font-bold text-[#333]">$199/yr</strong></p>
              <button
                onClick={() => openPayment({ name: "Pro", price: "$199", color: "bg-primary" })}
                className="block w-full py-3.5 bg-[#111] hover:bg-[#333] text-white font-bold rounded-xl text-center transition-colors mb-5 text-sm"
              >Start now</button>

              {/* Features box */}
              <div className="bg-[#edfaf2] rounded-xl p-4 mb-5">
                <p className="text-[10px] font-black uppercase tracking-[0.08em] text-[#777] mb-3 pb-2.5 border-b border-black/[0.08]">Included in Pro</p>
                <div className="space-y-2.5">
                  {[
                    { text: "Articles of Organization filing", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16"><path d="M8 2l1 4h4l-3 2 1 4-3-2-3 2 1-4-3-2h4z" fill="#2d7a4e"/></svg> },
                    { text: "100% accuracy guarantee", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" stroke="#2d7a4e" strokeWidth="1.5" fill="none"/><path d="M5 8l2 2 4-4" stroke="#2d7a4e" strokeWidth="1.5" fill="none"/></svg> },
                    { text: "Employer ID Number (EIN)", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><rect x="2" y="2" width="12" height="12" rx="2" stroke="#2d7a4e" strokeWidth="1.3"/><path d="M8 5v6M5 8h6" stroke="#2d7a4e" strokeWidth="1.3" strokeLinecap="round"/></svg> },
                    { text: "Operating agreement template", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><rect x="2" y="3" width="12" height="10" rx="1.5" stroke="#2d7a4e" strokeWidth="1.3"/><path d="M5 7h6M5 10h4" stroke="#2d7a4e" strokeWidth="1.3" strokeLinecap="round"/></svg> },
                    { text: "1 year registered agent service", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="6" r="2.5" stroke="#2d7a4e" strokeWidth="1.3"/><path d="M3 14c0-2.8 2.2-5 5-5s5 2.2 5 5" stroke="#2d7a4e" strokeWidth="1.3"/></svg> },
                    { text: "Annual report & compliance filing", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><path d="M2 4h12v8H2zM2 8h12" stroke="#2d7a4e" strokeWidth="1.3"/><path d="M6 4v4" stroke="#2d7a4e" strokeWidth="1.3"/></svg> },
                    { text: "Lifetime compliance alerts", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><path d="M3 3h10v10H3z" stroke="#2d7a4e" strokeWidth="1.3"/><path d="M6 8h4M8 6v4" stroke="#2d7a4e" strokeWidth="1.3" strokeLinecap="round"/></svg> },
                  ].map((f) => (
                    <div key={f.text} className="flex items-start justify-between gap-2">
                      <div className="flex items-start gap-2.5 flex-1">
                        <div className="w-7 h-7 rounded-md bg-[#c6f0d8] flex items-center justify-center shrink-0 mt-0.5">{f.icon}</div>
                        <span className="text-[0.85rem] text-[#222] leading-snug">{f.text}</span>
                      </div>
                      <Info className="w-4 h-4 text-[#6fa0c8] shrink-0 mt-1" />
                    </div>
                  ))}
              ...
              {/* Special offer */}
              <p className="text-[10px] font-black uppercase tracking-[0.08em] text-[#777] mb-3">Special Pro Offer</p>
              <div className="flex items-start justify-between gap-2">
                <div className="flex items-start gap-2.5 flex-1">
                  <div className="w-7 h-7 rounded-md bg-[#e8eef5] flex items-center justify-center shrink-0">
                    <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6" stroke="#4a7eaa" strokeWidth="1.5"/><path d="M8 5v3l2 1" stroke="#4a7eaa" strokeWidth="1.3" strokeLinecap="round"/></svg>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-2.5">
                <span className="text-2xl font-black text-[#111]">Premium</span>
                <span className="inline-flex items-center gap-1 text-[11px] font-semibold px-3 py-1 rounded-full bg-[#fef3c7] text-[#92400e]">
                  <svg className="w-3 h-3" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="5" width="12" height="8" rx="1"/><path d="M5 5V4a3 3 0 016 0v1"/></svg>
                  Best Value
                </span>
              </div>
              <p className="text-[#555] text-sm leading-relaxed mb-4 min-h-[42px]">Our most complete package — includes trademark search, legal docs, tax consultation, and priority support.</p>
              <div className="text-[2rem] font-black text-[#111] leading-none mb-1">$399</div>
              <p className="text-xs text-[#666] mb-4">+ state fees | renews at <strong className="font-bold text-[#333]">$399/yr</strong></p>
              <button
                onClick={() => openPayment({ name: "Premium", price: "$399", color: "bg-accent" })}
                className="block w-full py-3.5 bg-[#111] hover:bg-[#333] text-white font-bold rounded-xl text-center transition-colors mb-5 text-sm"
              >Start now</button>

              {/* Features box */}
              <div className="bg-[#fef9ec] rounded-xl p-4 mb-5">
                <p className="text-[10px] font-black uppercase tracking-[0.08em] text-[#777] mb-3 pb-2.5 border-b border-black/[0.08]">Included in Premium</p>
                <div className="space-y-2.5">
                  {[
                    { text: "Articles of Organization filing", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16"><path d="M8 2l1 4h4l-3 2 1 4-3-2-3 2 1-4-3-2h4z" fill="#92400e"/></svg> },
                    { text: "100% accuracy guarantee", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" stroke="#92400e" strokeWidth="1.5" fill="none"/><path d="M5 8l2 2 4-4" stroke="#92400e" strokeWidth="1.5" fill="none"/></svg> },
                    { text: "Employer ID Number (EIN)", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><rect x="2" y="2" width="12" height="12" rx="2" stroke="#92400e" strokeWidth="1.3"/><path d="M8 5v6M5 8h6" stroke="#92400e" strokeWidth="1.3" strokeLinecap="round"/></svg> },
                    { text: "Operating agreement & bylaws", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><rect x="2" y="3" width="12" height="10" rx="1.5" stroke="#92400e" strokeWidth="1.3"/><path d="M5 7h6M5 10h4" stroke="#92400e" strokeWidth="1.3" strokeLinecap="round"/></svg> },
                    { text: "1 year registered agent service", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="6" r="2.5" stroke="#92400e" strokeWidth="1.3"/><path d="M3 14c0-2.8 2.2-5 5-5s5 2.2 5 5" stroke="#92400e" strokeWidth="1.3"/></svg> },
                    { text: "Annual report & compliance filing", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><path d="M2 4h12v8H2zM2 8h12" stroke="#92400e" strokeWidth="1.3"/><path d="M6 4v4" stroke="#92400e" strokeWidth="1.3"/></svg> },
                    { text: "Trademark name search", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><path d="M4 4h8l2 4-2 4H4l-2-4z" stroke="#92400e" strokeWidth="1.3"/></svg> },
                    { text: "DBA (Doing Business As) registration", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><path d="M2 3h12v10H2z" stroke="#92400e" strokeWidth="1.3"/><path d="M2 6h12" stroke="#92400e" strokeWidth="1.3"/></svg> },
                    { text: "Business license research", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><path d="M3 3h10v10H3z" stroke="#92400e" strokeWidth="1.3"/><path d="M6 8h4M8 6v4" stroke="#92400e" strokeWidth="1.3" strokeLinecap="round"/></svg> },
                    { text: "IRS S-Corp election (Form 2553)", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><path d="M8 2c-1 0-3 1-3 3 0 1 .5 2 1.5 2.5L8 14l1.5-6.5C10.5 7 11 6 11 5c0-2-2-3-3-3z" stroke="#92400e" strokeWidth="1.3"/></svg> },
                    { text: "Business advisor consultation", icon: <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><circle cx="6" cy="6" r="2.5" stroke="#92400e" strokeWidth="1.3"/><circle cx="10" cy="6" r="2.5" stroke="#92400e" strokeWidth="1.3"/><path d="M1 14c0-2 1.8-3.5 4-3.5M15 14c0-2-1.8-3.5-4-3.5" stroke="#92400e" strokeWidth="1.3"/></svg> },
                  ].map((f) => (
                    <div key={f.text} className="flex items-start justify-between gap-2">
                      <div className="flex items-start gap-2.5 flex-1">
                        <div className="w-7 h-7 rounded-md bg-[#fde68a] flex items-center justify-center shrink-0 mt-0.5">{f.icon}</div>
                        <span className="text-[0.85rem] text-[#222] leading-snug">{f.text}</span>
                      </div>
                      <Info className="w-4 h-4 text-[#6fa0c8] shrink-0 mt-1" />
                    </div>
              ...
              {/* Special offers */}
              <p className="text-[10px] font-black uppercase tracking-[0.08em] text-[#777] mb-3">Special Premium Offers</p>
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-start gap-2.5 flex-1">
                    <div className="w-7 h-7 rounded-md bg-[#fef3c7] flex items-center justify-center shrink-0">
                      <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="none"><rect x="2" y="5" width="12" height="8" rx="1" stroke="#92400e" strokeWidth="1.3"/><path d="M5 5V4a3 3 0 016 0v1" stroke="#92400e" strokeWidth="1.3"/></svg>
                    </div>
                    <div>
                      <p className="text-[0.85rem] text-[#222] font-semibold leading-snug">Free business tax consultation</p>
                      <span className="text-[0.78rem] text-[#777]">30-min session with a tax advisor†</span>
                    </div>
                  </div>
                  <Info className="w-4 h-4 text-[#6fa0c8] shrink-0 mt-1" />
                </div>
