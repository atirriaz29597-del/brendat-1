           ...
           <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                 <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                    ...
                    <h3 className="text-2xl font-black text-gray-900 mb-2">Shield Your Trademark from Infringement with Affordable Plan</h3>
                    <p className="text-gray-500 mb-6">Trademark monitoring in USA. You’ll never have to recheck the USPTO manually. We watch the databases so you don’t have to.</p>
                    <div className="flex items-baseline gap-1 mb-6">
                       <span className="text-4xl font-black text-accent">$175</span>
                    </div>
