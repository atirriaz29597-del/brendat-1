        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-black text-gray-900 mb-4">What’s Included in Our Operating Agreement Services in USA, USA</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {pricingPlans.map((plan, i) => (
                <div key={i} className={`relative bg-white rounded-3xl p-8 border-2 ${plan.color === "accent" ? "border-accent shadow-2xl shadow-accent/10 md:scale-105 z-10" : "border-gray-200 shadow-xl"} flex flex-col`}>
