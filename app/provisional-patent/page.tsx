          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
             ...
             <div>
                <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden">
                   ...
                   <h3 className="text-2xl font-black text-gray-900 mb-2">Provisional patent application</h3>
                   <div className="flex items-baseline gap-1 mb-6">
                      <span className="text-4xl font-black text-accent">$199</span>
                   ...
                   <Link href="/order/step2" className="block w-full text-center bg-accent text-white py-3 rounded-xl font-bold mb-8 hover:bg-accent/90 transition shadow-lg shadow-accent/20">
                      Start My Provisional Patent
                   </Link>
                   <div className="space-y-4">
                      <p className="font-bold text-gray-900">What we do for you</p>
